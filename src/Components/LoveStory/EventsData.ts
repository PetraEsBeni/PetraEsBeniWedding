...
export const Events = [
    { 
        title: "Így kezdődött…", 
        desc: "Először közös barátokon keresztül találkoztunk, amikor még mindketten más párkapcsolatban voltunk. A szakításaink után ez a négyes barátság megmaradt, de egy véletlen alkalommal csak ketten maradtunk, akkor beszélgettünk először igazán. Ekkor indult el valami igazán különleges.", 
        image: FirstImg 
    },
    { 
        title: "Az első csók", 
    ...
    { 
        ...
        desc: "Az évek során a közös utazások és a zene világa fontos részei lettek az életünknek. Imádunk felderíteni új helyeket, akár kettesben, akár barátokkal vagy családdal. \nEgyütt fedeztük fel a techno világát, és azóta is sok emlék köt minket fesztiválokhoz, bulikhoz, hosszú éjszakákhoz – tele nevetéssel és szabadsággal. \nEzek az élmények színesítették és mélyítették a kapcsolatunkat, és rengeteg boldog emléket adtak nekünk.", 
        image: FifthImg 
    },
    { 
